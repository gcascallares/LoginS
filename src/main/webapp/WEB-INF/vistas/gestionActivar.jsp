		      ...
		      <div class="container">
		        ...
		        <div class="row">
		          <div class="span12">
			          ...
			          <h4>Activar Usuarios</h4>
				          <form:form class="text-center" method="post" action="activar" modelAttribute="usuario">							
						    ...
						    <button type="submit" id="btn-modificar" value="modificar" class="btn btn-primary">Activar</button>
						</form:form>
			          </div>
		          </div>
		        </div>
